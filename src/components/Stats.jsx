...
const Stats = () => {
  ...
  return (
    <div className="text-white">
      ...
      <div className="sticky top-0 z-10 flex items-center justify-center p-4 mb-6 bg-black">
        {/* <h2 className="text-2xl font-bold">Statistics</h2> */}
        <div className="flex gap-12"> {/* Increased gap from 8 to 12 for more spacing */}
          {statsSections.map((section) => (
            <button
              key={section}
              onClick={() => setActiveStatsSection(section)}
              className={`relative inline-flex items-center justify-center px-10 py-2 text-sm font-medium transition-all duration-200 rounded-md group ${activeStatsSection === section
